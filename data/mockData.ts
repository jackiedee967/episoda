...
export const mockComments: Comment[] = [
  {
    ...
    postId: 'post-1',
    user: mockUsers[1],
    comment_text: 'OMG YES! I totally agree with this theory. The way they set it up in the previous episode was so obvious!',
    likes: 0,
    isLiked: false,
    ...
    replies: [
      {
        ...
        commentId: 'comment-1',
        user: mockUsers[2],
        comment_text: 'Right?! I can&apos;t believe more people aren&apos;t talking about this',
        likes: 0,
        isLiked: false,
      ...
      },
      {
        ...
        commentId: 'comment-1',
        user: currentUser,
        comment_text: 'Exactly! The foreshadowing was incredible',
        likes: 0,
        isLiked: false,
  ...
  },
  {
    ...
    postId: 'post-1',
    user: mockUsers[2],
    comment_text: 'I have a different take on this. What if they&apos;re actually setting up something completely different?',
    likes: 0,
    isLiked: false,
  ...
  },
  {
    ...
    postId: 'post-1',
    user: mockUsers[1],
    comment_text: 'This episode was INSANE! Can&apos;t wait for next week',
    ...
    replies: [
      {
        ...
        commentId: 'comment-3',
        user: mockUsers[3],
        comment_text: 'Same! The cliffhanger was brutal',
        likes: 0,
        isLiked: false,
